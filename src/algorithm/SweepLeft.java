...
//    int nbZeroInPStatus;
//
//    public SweepLeft(DataStructure structure){
...
//        if(qEvents.size() == 0 || qEvents.get(0).getValue() > structure.getDomain().getMinX() ){
...
//                while(qEvents.size() > 0 && Math.max(structure.getDomain().getMinX(),qEvents.get(0).getValue()) == delta){
//
